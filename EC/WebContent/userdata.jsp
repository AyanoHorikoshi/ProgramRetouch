...
<%
	...
	ArrayList<BuyDataBeans> buyIDBList = (ArrayList<BuyDataBeans>) request.getAttribute("buyIDBList");
%>
</head>
<body>
				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
								<%
									for (BuyDataBeans buyIDB : buyIDBList) {
								%>
								<tr>
									<td class="center"><a href="UserBuyHistoryDetail?buy_id=<%=buyIDB.getId()%>" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
									<td class="center"><%=buyIDB.getFormatDate()%></td>
									<td class="center"><%=buyIDB.getDeliveryMethodName()%></td>
									<td class="center"><%=buyIDB.getTotalPrice()%>円</td>
								</tr>
								<%
									}
								%>
